...
export const RecoverySuccessFulForm: React.FC<{ onNext: () => void }> = ({
  onNext,
}) => {
  ...
  return (
    <div className="recoverySucessfull-main-container">
      <span
        className="recoverySucessfull-title"
        style={{ color: currentTheme?.authPages.commonElements.logoColorText }}
      >
        {t("ur_password_has_changed")}
      </span>
      <button
