...
export const SchedulePlanGroupDialog: React.FC<
  SchedulePlanGroupDialogProps
> = ({ planGroupId, open, setOpen }) => {
  ...
  const handleSubmit = (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    switch (type) {
      ...
      case "OneOff":
        ...
        setDateTime(dateTime.subtract(dayjs().utcOffset(), "minute"));
        break;
      case "Recurring":
        setDateTime(null!);
  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="xs">
      ...
      <DialogContent>
        <DialogContentText>Type in the required information</DialogContentText>
