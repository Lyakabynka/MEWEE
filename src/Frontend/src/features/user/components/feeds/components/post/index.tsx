            ...
            <footer>
                ...
                <nav className='feed-post-nav'>
                    ...
                    <div className='feed-post-tools'>
                        ...
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="#B67AFE" xmlns="http://www.w3.org/2000/svg">
                            <path d="M20.2338 15.6356C20.7253 14.5238 20.9983 13.2938 20.9983 12C20.9983 7.02944 16.9692 3 11.9991 3C7.02906 3 3 7.02944 3 12C3 16.9706 7.02906 21 11.9991 21C13.5993 21 15.1019 20.5823 16.4039 19.85L21 20.9991L20.2338 15.6356Z" stroke="#B67AFE" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </div>
                </nav>
            </footer>
