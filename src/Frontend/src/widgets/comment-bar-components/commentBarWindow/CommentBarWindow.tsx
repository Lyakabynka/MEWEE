...
import styles from "./comment_bar_window.module.scss";
...
const CommentBarWindow: FC<CommentBarPropsTypes> = ({
  id,
  hiden,
  appearance,
  commentDataRender,
  ...
  return (
    <>
      {hiden === id && (
        <div
          className={
            appearance ? (hiden == null ? styles.comments : `${styles.comments} ${styles._comments_visible}`) : styles.comments_full
          }
        >
          {commentDataRender &&
...
export default CommentBarWindow;
